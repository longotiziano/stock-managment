...
def verify_task(
    ...
    '''
    Verifies CSV files generated by a previous task using a specified verifier class and method.    
    There's no need to log as much as it takes to log the "conversion_tasks", because the verifying methods already
    work on that.
    '''  
    ...
    if not ok:
        # "dir_csvs" will be an exception if it's not ok.
    ...
    with SessionLocal() as session:
        ...
        for file in csv_files:
            ...
            # Knowing that the ProductsDfVerifier hasn't a "direction" parameter, I apply this strategy
            if direction:
